...
export function buildCloudHelpText(platform: "telegram" | "slack", lang: UserLanguage): string {
  ...
  const lines = [
    ...
    "",
    t("cloud.help.group_mcp", lang),
    t("cloud.help.cmd.mcp_github_token", lang, { cmd: `\`${cmd("mcp github token set <token>")}\`` }),
    t("cloud.help.cmd.mcp_github_token_status", lang, { cmd: `\`${cmd("mcp github token status")}\`` }),
    t("cloud.help.cmd.mcp_github_token_delete", lang, { cmd: `\`${cmd("mcp github token delete")}\`` }),
    t("cloud.help.cmd.mcp_exa_key", lang, { cmd: `\`${cmd("mcp exa key set <key>")}\`` }),
    t("cloud.help.cmd.mcp_exa_key_status", lang, { cmd: `\`${cmd("mcp exa key status")}\`` }),
    t("cloud.help.cmd.mcp_exa_key_delete", lang, { cmd: `\`${cmd("mcp exa key delete")}\`` }),
    t("cloud.help.cmd.mcp_parallel_key", lang, { cmd: `\`${cmd("mcp parallel key set <key>")}\`` }),
    t("cloud.help.cmd.mcp_parallel_key_status", lang, { cmd: `\`${cmd("mcp parallel key status")}\`` }),
    t("cloud.help.cmd.mcp_parallel_key_delete", lang, { cmd: `\`${cmd("mcp parallel key delete")}\`` }),
    ...
    t("cloud.help.cmd.mcp_notion_disconnect", lang, { cmd: `\`${cmd("mcp notion disconnect")}\`` }),
    "",
