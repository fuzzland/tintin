/**
 * SessionListFormatter - Format session lists for display.
 *
 * Provides consistent formatting of session lists across all platforms.
 * Extracted from controller/sessions.ts for shared use.
 */
...
export interface FormatSessionListOptions extends SessionListPage {
  filterLabel?: string;
}
...
/**
 * Format session filter status to a label.
 */
...
/**
 * Build menu text for the given platform and agent.
 */
...
/**
 * Build command examples for the given platform.
 */
...
/**
 * Build cloud help text for the given platform.
 */
