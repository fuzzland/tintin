...
export function parseListSessionsArgs(text: string): { statuses?: SessionStatus[]; page: number } {
...
export function parseListSessionsIntentFromTelegram(text: string): { statuses?: SessionStatus[]; page: number } | null {
...
export function parseListSessionsIntentFromSlack(text: string): { statuses?: SessionStatus[]; page: number } | null {
